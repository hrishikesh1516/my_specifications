const cvData = {
    ...
    education: [
        {
            ...
            degree: "BS-MS in Geological Science",
            institution: "Indian Institute of Science Education and Research, Kolkata",
            description: "Currently persuing my major in Earth/geological sciences.Completed two years of pre-major(Theorotical and Laboratorical) training in Physics and Biology."
        }
    ],
    experience: [
        {
    ...
    certifications: [
        ...
        {
            title: "Properties of the Lithosphere: <br> links between Tectonics, Metamorphism and Surface Processe",
